...
function About() {
    return (
        <section id="intro">
         ...
         <div id="intro_2">   Based in Dehradun. I have done Btech in Computer Science from Graphic Era Hill University.<br></br>Having a keen interest
                in DevOps also. I have good knowledge of HTML, CSS, JAVASCRIPT, and MERN, also in Git, Jenkins, Kubernetes.<br></br> Along with development I have good hold in Data Structures and Algorithms.
            </div> 
